...
exec "$JAVA" $JAVA_OPTS $ORIENTDB_OPTS_MEMORY $JAVA_OPTS_SCRIPT $ORIENTDB_SETTINGS $MAXDISKCACHE \
    ...
    -Dorientdb.build.number="2.1.x@r13efec7610a3eceb539db5ebfb31dea2534aa819; 2016-04-19 10:56:07+0000" \
    -cp "$ORIENTDB_HOME/lib/orientdb-server-2.1.16.jar:$ORIENTDB_HOME/lib/*" \
