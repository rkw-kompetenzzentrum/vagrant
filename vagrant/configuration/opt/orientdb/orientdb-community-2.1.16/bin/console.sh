...
[ -f "$ORIENTDB_HOME"/lib/orientdb-tools-2.1.16.jar ] || ORIENTDB_HOME=`cd "$PRGDIR/.." ; pwd`
...
exec "$JAVA" -client $JAVA_OPTS $ORIENTDB_SETTINGS $SSL_OPTS \
    -Dfile.encoding=utf-8 -Dorientdb.build.number="2.1.x@r13efec7610a3eceb539db5ebfb31dea2534aa819; 2016-04-19 10:56:07+0000" \
    -cp "$ORIENTDB_HOME/lib/orientdb-tools-2.1.16.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" \
