...
[ -f "$ORIENTDB_HOME"/lib/orientdb-etl-2.1.16.jar ] || ORIENTDB_HOME=`cd "$PRGDIR/.." ; pwd`
...
$JAVA -server $JAVA_OPTS $ORIENTDB_SETTINGS $SSL_OPTS -Dfile.encoding=utf-8 -Dorientdb.build.number="2.1.x@r13efec7610a3eceb539db5ebfb31dea2534aa819; 2016-04-19 10:56:07+0000" -cp "$ORIENTDB_HOME/lib/*" com.orientechnologies.orient.etl.OETLProcessor $*
